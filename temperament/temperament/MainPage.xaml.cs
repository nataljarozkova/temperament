...
namespace Temperament
{
    public partial class MainPage : CarouselPage
    {
        ...
        {
            ur = new Uri("https://brainapps.ru/test/temperament");
            await Browser.OpenAsync(ur);
        }

        private async void Btn1_Clicked(object sender, EventArgs e)
        {
            ur = new Uri("https://moeobrazovanie.ru/prof_tests/test_temperament_i_professija.html");
            await Browser.OpenAsync(ur);
        }

        private async void Btn_Clicked(object sender, EventArgs e)
        {
            ur = new Uri("https://www.psychologies.ru/tests/test/875/");
            await Browser.OpenAsync(ur);
        }
    }
}
